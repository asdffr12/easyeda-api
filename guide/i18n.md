...
If you need to get all the language labels supported by the current extension, you can call the [SYS_I18n.getAllSupportedLanguages()](../references/classes/SYS_I18n.md) method, which will return an array of strings.
...
To use a multilingual system to display different text in different language environments, use the [SYS_I18n.text()](../references/classes/SYS_I18n.md) method.

[SYS_I18n.text()](../references/classes/SYS_I18n.md) method has a mandatory argument `tag`, which corresponds to the key name in the multilingual file, and the key value matched by that key name is the final displayed text.
