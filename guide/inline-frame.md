...
To use inline frames, you need to save all files in the extension's `/iframe/` directory and use [SYS_IFrame.openIFrame()](../references/classes/SYS_IFrame.md) method to load the specified `html` file as the content of the inline frame.
